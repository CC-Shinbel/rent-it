...
function initAdminPageSkeleton() {
    ...
    let overlay = document.querySelector('.admin-skeleton-overlay');

    if (!overlay) {
        overlay = document.createElement('div');
        overlay.className = 'admin-skeleton-overlay';
...
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initAdminPageSkeleton, { once: true });
} else {
